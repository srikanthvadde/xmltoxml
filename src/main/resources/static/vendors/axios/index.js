...
;(function(root, factory) {
  ...
  var Settings = NProgress.settings = {
    ...
    parent: 'body',
    template: '<div class="loader-overlay"><div class="bar" role="bar"><div class="peg"></div></div><div class="spinner" role="spinner"><button class="btn btn-primary"> <span class="spinner-border spinner-border-sm"></span>Loading..</button></div></div>'
  };
