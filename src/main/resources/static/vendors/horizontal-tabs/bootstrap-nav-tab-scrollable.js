...
(function ($){
    ...
    $.fn.horizontalTabs = function() {
        // Variable creation
        var $elem = $(this),
            widthOfReducedList = $elem.find('.nav-tabs').width(),
            widthOfList = 0,
            currentPos = 0,
            adjustScroll = function () {
                widthOfList = 0;
                $elem.find('.nav-tabs li').each(function(index, item) {
            ...
            manualScroll = function () {
                currentPos = $elem.find('.nav-tabs').scrollLeft();
