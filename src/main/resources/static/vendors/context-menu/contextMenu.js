	...
	if (!e) var e = window.event;
		...
		if (e.pageX || e.pageY) {
			...
			posy = e.pageY-135;
				...
				posx = e.clientX-80 + document.body.scrollLeft + document.documentElement.scrollLeft;
				posy = e.clientY-135 + document.body.scrollTop + document.documentElement.scrollTop;
		}
